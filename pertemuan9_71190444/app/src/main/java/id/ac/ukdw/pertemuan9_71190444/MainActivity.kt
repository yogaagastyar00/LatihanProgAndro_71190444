package id.ac.ukdw.pertemuan9_71190444
    ...
    override fun onItemSelected(parent: AdapterView<*>, view: View?, pos: Int, id: Long) {
        ...
        if (parent.getItemAtPosition(pos)!="Choose" && parent.getItemAtPosition(pos)!="Size") {
            if (parent.getItemAtPosition(pos).toString().toIntOrNull() != null) {
                ...
                } else if (parent.getItemAtPosition(pos).toString() == "Finlandia") {
                    textbahasa.setText("kieliasetus")
                    textfont.setText("Fonttikoko")
                } else if (parent.getItemAtPosition(pos).toString() == "Japanese") {
                    textbahasa.setText("言語設定")
                    textfont.setText("フォントサイズ")
                } else if (parent.getItemAtPosition(pos).toString() == "German") {
                    textbahasa.setText("Spracheinstellungen")
                    textfont.setText("Schriftgröße")
                ...
                } else if (parent.getItemAtPosition(pos).toString() == "Italia") {
                    textbahasa.setText("impostazione della lingua")
                    textfont.setText("Dimensione del font")
